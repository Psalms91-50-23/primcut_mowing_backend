...
import User from "../models/User.js"; // your users table model
import supabase from "../config/db.js";
import { resetPasswordLink } from "../lib/email/index.js";
import { generateShortId, verifyEmailToken, generateEmailToken, formatFullName, verifyRecaptcha } from '../util/util.js';
...
export const requestPasswordReset = async (req, res) => {
  ...
  try {
    console.log({recaptchaToken}, "recaptcha token in password reset");
    console.log({email}, "email in password reset");
    console.log({recaptchaVersion}, "recaptcha version in password reset");
    // Verify reCAPTCHA
