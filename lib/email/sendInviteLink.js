...
//       <p>You've been invited to join <strong>PrimCut</strong>. Click the button below to set your password and access your account.</p>

//       <div style="margin: 30px 0; text-align: center;">
//         <a
//           href="${inviteLink}"
//           style="background: #1f7a6b; color: white; padding: 14px 22px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block;"
//         >
//           Set Your Password
//         </a>
//       </div>

//       <p style="font-size: 14px; color: #555;">This link will expire in <strong>${expiryHours} hours</strong>.</p>

//       <p style="font-size: 14px; color: #555;">If you weren't expecting this invite, you can ignore this email.</p>
...
//   console.log("Invite email sent to client via Resend!");
// }
...
export default async function sendInviteLink({
  ...
  const mailOptions = {
    ...
    to,
    subject: "You're invited to Happy Property!",
    html: `
      <div style="font-family: Arial, sans-serif; color: #333; max-width: 700px; margin: auto;">
        ...
        <div style="background: #fff; padding: 20px 16px; border-radius: 0 0 10px 10px; border: 1px solid #eee; border-top: none;">
          ...
          <p>
            You've been invited to join <strong>Happy Property</strong>. Click the button below to set your password and access your account.
          </p>
    ...
    You've been invited to join Happy Property.
