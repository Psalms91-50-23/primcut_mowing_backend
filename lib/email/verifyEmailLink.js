...
export default async function verifyEmailLink({
    ...
    <div style="background: #064e3b; padding: 20px 16px; border-radius: 10px 10px 0 0; display: flex; align-items: center;">
      <h1 style="margin: 0; font-weight: bold; font-size: 28px; color: #fff; display: flex; align-items: center;">
        ...
        <span style="margin: 0 4px;">
          <img src="https://${process.env.FRONTEND_URL_HAPPY_LAWNS}/images/happy-house-1.png" alt="Happy Property Logo" style="width: 64px; height: 64px; vertical-align: middle; margin-left: 4px;" />
        </span>
        <span style="font-size: 36px; margin: 0 4px;">ppy Property</span>
      </h1>
    </div>
  ...
  Thanks for creating an account with Happy Property.
