...
export default async function sendQuoteRejected({ to, quote }) {
  ...
  <div style="font-family: Arial, sans-serif; max-width: 700px; margin: auto; color: #1f2937;">
    ...
    <div style="background: #14532D; padding: 20px; border-radius: 10px 10px 0 0;">
      <h1 style="margin:0; font-weight:bold; font-size:28px; color:#fff; display:flex; align-items:center; gap:4px;">
        ...
        <img src="${process.env.FRONTEND_URL_HAPPY_PROPERTY}/images/happy-house-1.png" alt="Happy Property Logo" style="width:64px;height:64px;" />
  ...
  console.log("Quote rejected email sent to client via Resend!");
}
...
//       <h1 style="margin:0; font-weight:bold; font-size:28px; color:#fff; display:flex; align-items:center; gap:4px;">
//         <span style="font-size:36px;">H</span>
//         <img src="https://${process.env.FRONTEND_URL_HAPPY_LAWNS}/images/happy-house-1.png" alt="Happy Property Logo" style="width:64px;height:64px;" />
//         <span style="font-size:36px;">ppy Property</span>
//       </h1>
//     </div>
