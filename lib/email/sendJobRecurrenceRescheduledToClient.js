...
export default async function sendJobRecurrenceRescheduledToClient({
    ...
    <div style="max-width:760px;margin:24px auto;color:#1f2937;background:#ffffff;">
      ...
      <div style="background:#ffffff;padding:24px;border-radius:0 0 10px 10px;border:1px solid #e5e7eb;border-top:none;">
        ...
        <p>
          ...
          <strong> ${introActionText}</strong>.
        </p>

        <p>
          Please review the updated schedule details below.
        </p>

        <p>
          Changes can sometimes happen due to weather conditions, site access issues,
  ...
  We wanted to let you know that your scheduled service has been ${introActionText}.

  Please review the updated schedule details below.

  Changes can sometimes happen due to weather conditions, site access issues, safety concerns, staffing availability, or other operational reasons.
